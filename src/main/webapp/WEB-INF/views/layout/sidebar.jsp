...
<nav id="sidebar" style="background-image: url('static/images/layout_img/pattern_h.png')">
    <h4>General</h4>
    <ul class="list-unstyled components">
        <li><a href="dashboard"><i class="fas fa-chart-line"></i> <span>Dashboard</span></a></li>
        <li><a href="patients"><i class="fas fa-user-injured"></i> <span>Patients</span></a></li>
