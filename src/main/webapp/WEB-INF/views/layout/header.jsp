...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/perfect-scrollbar.css">
    ...
    <script src="${pageContext.request.contextPath}/static/js/Chart.bundle.min.js"></script>
    <script src="${pageContext.request.contextPath}/static/js/utils.js"></script>
    <script src="${pageContext.request.contextPath}/static/js/analyser.js"></script>
    <script src="${pageContext.request.contextPath}/static/js/perfect-scrollbar.min.js"></script>
    <script>
        var ps = new PerfectScrollbar('#sidebar');
    </script>
    <script src="${pageContext.request.contextPath}/static/js/chart_custom_style1.js"></script>
